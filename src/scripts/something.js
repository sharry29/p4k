			...
			i({
				...
				selection: o.list.find(function(e) {
					return t.keyCode === f
						...
						: 'mousedown' === t.type
						? e.index === Number(t.target.getAttribute(a))
						: void 0
				})
			}),
				s(n)
		...
		return (function() {
			function K(e) {
				...
				;(this.selector = n),
					...
					(this.threshold = g),
					(this.debounce = b),
					(this.resultsList = { render: C, view: J, navigation: T }),
					(this.sort = P),
					(this.placeHolder = I),
					(this.maxResults = N),
				...
				(function(e, t, n) {
					...
					},
					{
						...
						value: function() {
							var t = this
							this.data.cache
								? Promise.resolve(this.data.src()).then(
										function(e) {
